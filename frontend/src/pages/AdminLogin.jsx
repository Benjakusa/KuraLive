                    ...
                    <div style={{ display: 'grid', gap: 'var(--space-4)' }}>
                        <div style={{ position: 'relative' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@uchaguzi360.com" required style={{ width: '100%', padding: '14px 16px 14px 48px', background: darkMode ? 'rgba(0, 26, 26, 0.5)' : 'var(--color-surface)', border: darkMode ? '1px solid rgba(0, 230, 230, 0.15)' : '1px solid var(--color-border)', borderRadius: 'var(--radius-md)', color: darkMode ? 'var(--white)' : 'var(--color-text-main)', fontSize: '0.95rem', fontFamily: 'inherit', outline: 'none', transition: 'all 0.2s ease', boxSizing: 'border-box' }}
